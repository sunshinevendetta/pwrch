  ...
  useEffect(() => {
    ...
    const animations = [
      ...
      },
      {
        ...
        target: "#myText2",
        duration: 5,
        text: "欢迎来到金融科技竞技场，旨在挑战交易者，使用专业工具和策略在高风险的模拟交易环境中进行竞赛。"
      },
      {
        trigger: ".purple",
        target: "#myText3",
        duration: 7,
        text: "赢家将通过展示出色的交易洞察力和策略来战胜对手并获得胜利。"
      }
    ];
      ...
      <div>
        <section className="panel green hover-gradient-amber-5 mx-auto text-center relative h-96">
          <div className="absolute inset-0">
            <Image src="/images/blog/fintechpass.webp" alt="背景图片" className="opacity-30" fill style={{ objectFit: "cover" }} />
        ...
        <section className="panel orange mx-auto text-center relative h-96">
          <div className="absolute inset-0">
            <Image src="/images/blog/fintech2.webp" alt="背景图片" className="opacity-70" fill style={{ objectFit: "cover" }} />
            <div className="absolute inset-0 bg-black bg-opacity-50"></div>
          </div>
          <div className="relative z-10 p-6 flex items-center justify-center flex-col">
        ...
        <section className="panel purple mx-auto text-center relative h-96">
          <div className="absolute inset-0">
            <Image src="/images/blog/fintech.webp" alt="背景图片" className="opacity-60 hover-gradient-amber-5 hoover:blur-xs rounded-lg z-0" fill style={{ objectFit: "cover" }} />
            <div className="absolute inset-0 bg-black bg-opacity-50"></div>
          </div>
          <div className="relative z-10 p-6 flex items-center justify-center flex-col">
