    ...
    <>
      <div className="container relative md:mt-24 mt-16">
        <div className="grid grid-cols-1 pb-6 text-center">
          <h3 className="mb-4 md:text-4xl md:leading-normal text-2xl leading-normal font-semibold">新闻</h3>
          <p className="text-slate-400 max-w-xl mx-auto">教育是力量，阅读最新的新闻和文章，开始您的旅程</p>
        </div>
